...
#Create csv file
budget_data_csv_path = os.path.join("C:/Users/Leah/Downloads/Copy of budget_data.csv")
...
open for row in csvreader

#Reading the first row to make sure everything is correct
